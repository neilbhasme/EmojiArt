...
//  EmojiArt
//
//  Created by Neil R.Bhasme on 30/04/2019.
...
class EmojiArtDocumentTableViewController: UITableViewController {
    ...
    // MARK: - Table view data source //NRB UITableViewDataSource methods
    ...
    */
    ...
    override func viewWillLayoutSubviews() {
        ...
        //Table view to always appear on top of emoji art view

//NRB - Strangely not working in simulator / not able to get the gesture right..dunno
